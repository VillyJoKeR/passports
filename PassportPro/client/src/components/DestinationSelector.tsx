...
interface DestinationSelectorProps {
  ...
  countries: Country[];
  isLoading: boolean;
  excludeCode?: string; // Optional code to exclude (e.g., passport country)
}
...
export default function DestinationSelector({ 
  ...
  const filteredCountries = excludeCode 
    ? countries.filter(country => country.code !== excludeCode)
    : countries;

  const selectedCountry = filteredCountries.find(c => c.code === value);
    ...
    <div className="mb-6">
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="p-0 w-full min-w-[240px] max-w-[400px] max-h-[300px]">
          <Command>
            <CommandInput placeholder="Search destination country..." />
